...
//new code
var createPost = require('./services/createpost');
var createCommentVar = require('./services/createcomment');
...
//new code
var createPost_consumer = connection.getConsumer(topics.CREATE_POSTS);
var listPosts_consumer = connection.getConsumer(topics.LIST_POSTS);
var fetchPost_consumer = connection.getConsumer(topics.FETCH_POST);
var deletePost_consumer = connection.getConsumer(topics.DELETE_POST);

var createComment_consumer = connection.getConsumer(topics.CREATE_COMMENT);
var listComment_consumer = connection.getConsumer(topics.GET_COMMENTS);
...
//new code createPost_consumer
createPost_consumer.on('message', function (message) {
    console.log('message received in createPost_consumer');
    //console.log(message.topic);    
    //console.log(JSON.stringify(message.value));

    var data = JSON.parse(message.value);
    console.log("KAFKA_SERVER createPost_consumer data",data.data);

    createPost.createPost(data.data, function (err, res) {
...
//new code
listPosts_consumer.on('message', function (message) {
    console.log('message received in listPosts_consumer');
    //console.log(message.topic);    
    //console.log(JSON.stringify(message.value));

    var data = JSON.parse(message.value);
    //console.log("KAFKA_SERVER listPosts_consumer data",data.data);

    createPost.listPosts(data.data, function (err, res) {
        console.log('after handle : ' + res + err);
...
//new code
fetchPost_consumer.on('message', function (message) {
    console.log('message received in fetchPost_consumer');
    console.log(message.topic);    
    console.log(JSON.stringify(message.value));

    var data = JSON.parse(message.value);
    console.log("KAFKA_SERVER fetchPost_consumer data",data);

    createPost.fetchPostData(data.data, function (err, res) {
        console.log('after handle : ' + res + err);
...
//new code
deletePost_consumer.on('message', function (message) {
    console.log('message received in deletePost_consumer');
    console.log(message.topic);    
    console.log(JSON.stringify(message.value));

    var data = JSON.parse(message.value);
    console.log("KAFKA_SERVER deletePost_consumer data",data);

    createPost.deletePostData(data.data, function (err, res) {
        console.log('after handle : ' + res + err);
...
//new code 12/06/22
createComment_consumer.on('message', function (message) {
    console.log('message received in createComment_consumer');
    console.log(message.topic);    
    //console.log(JSON.stringify(message.value));

    var data = JSON.parse(message.value);
    console.log("KAFKA_SERVER createComment_consumer data",data.data);

    createCommentVar.createComment(data.data, function (err, res) {
        console.log('after handle : ' + res + err);
...
listComment_consumer.on('message', function (message) {
    console.log('message received in createComment_consumer');
    console.log(message.topic);  
    var data = JSON.parse(message.value);
    console.log("KAFKA_SERVER createComment_consumer data",data.data);

    createCommentVar.listComments(data.data, function (err, res) {
        console.log('after handle : ' + res + err);
...
register_consumer.on('message', function (message) {
    ...
    var data = JSON.parse(message.value);
    console.log("KAFKA_SERVER register consumer data",data.data);
