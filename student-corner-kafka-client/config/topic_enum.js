...
exports.res_topic_names = {
    ...
    // added new code for posts
    CREATE_POSTS: 'createPost_response',
    LIST_POSTS: 'listPost_response',
    FETCH_POST: 'fetchPost_response',
    DELETE_POST: 'deletePost_response',
    CREATE_COMMENT: 'createComment_response',
    GET_COMMENTS: 'getComment_response',
};