...
app.use('/', index);
app.post('/registerUser', dropboxController.registerUser);
...
//app.post('/getUserDetails', dropboxController.fetchUserDetails); //fetching from MongoDB 
...
//new code - 11/22/2022
app.post('/posts', dropboxController.createPost);
app.get('/listposts', dropboxController.listPost);
app.get('/fetchPost/:id', dropboxController.fetchPostDetails);
app.delete('/deletePost/:id', dropboxController.deletePostDetails);

//new code - 12/06/2022
app.post('/createcomment', dropboxController.createComment);
app.get('/listcomments/:id', dropboxController.listComment);
...
app.use(function(err, req, res, next) {
    console.log('error handler in client 98  '+err);
