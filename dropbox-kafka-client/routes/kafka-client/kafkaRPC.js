...
KafkaRPC.prototype.setupResponseQueue = function (topic_name, next) {
    ...
    var createPost_consumer = self.connection.getConsumer(response_topics.CREATE_POSTS);
    var listPost_consumer = self.connection.getConsumer(response_topics.LIST_POSTS);
    var fetchPost_consumer = self.connection.getConsumer(response_topics.FETCH_POST);
    var deletePost_consumer = self.connection.getConsumer(response_topics.DELETE_POST);

    createPost_consumer.on('message', function (message) {
        console.log('createPost_consumer msg received for topic name', topic_name, message);
    ...
    listPost_consumer.on('message', function (message) {
        console.log('listPost_consumer msg received for topic name', topic_name, message);
        var data = JSON.parse(message.value);
    ...
    fetchPost_consumer.on('message', function (message) {
        console.log('fetchPost_consumer msg received for topic name', topic_name, message);
        var data = JSON.parse(message.value);
    ...
    deletePost_consumer.on('message', function (message) {
        console.log('deletePost_consumer msg received for topic name', topic_name, message);
        var data = JSON.parse(message.value);
    ...
    register_consumer.on('message', function (message) {
        console.log('register_consumer msg received for topic name', topic_name, message);
        var data = JSON.parse(message.value);
    ...
    login_consumer.on('message', function (message) {
        console.log('login_consumer msg received');
        var data = JSON.parse(message.value);
